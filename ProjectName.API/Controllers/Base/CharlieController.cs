...
namespace ProjectName.API.Controllers.Base
{
  ...
  [ApiController]
  public class CharlieController<TController, TEntity, DtoSearch, DtoResponse, DtoCreate>
    ...
    where TController: class
  {
    ...
    public CharlieController(ILogger<TController> logger, IMapper mapper, IUnitOfWork unitOfWork) : base(logger, mapper, unitOfWork)
    {
